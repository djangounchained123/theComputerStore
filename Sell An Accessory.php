        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
            <div class="placeholder">
                  <a href="Sell An Accessory.php#JumpToForms"><img src="Sell An Accessory.jpg" width="700" height="100%" class="img-responsive" alt="Generic placeholder thumbnail" style="border-radius:30px;"></a>
                  <h4 id="JumpToForms">Our Sales</h4>
                  <span class="text-muted">Accessories</span>
                  <br/><br/><br/>
                  <h4>Sell An Accessory</h4>
            </div>
            <div style="align: center; position : relative; right: 34%">
                 <form class="navbar-form navbar-right" method="POST" style="position : relative;">
                      ...
                      <div><input type="text" style="width: 100%;" class="form-control" name="ProductName" placeholder="Accessory Name" required></div>
          ...
          <Purchase>
              <?php
                    ...
                    if(isset($_POST['StoreName']) && isset($_POST['ProductName']) && isset($_POST['EmployeeName']) && isset($_POST['Quantity']) && isset($_POST['PricePerPiece']) && isset($_POST['PurchaseDate']))
                    {
                          ...
                          $InsertedProductNameExistssql = "SELECT AccessoryID FROM Accessory WHERE Accessory_Name='$InsertProdtuctName'";
                          ...
                          $InsertedProductNameValue = $InsertedProductName['AccessoryID'];
                          ...
                          $MaxSoldIDsql = "SELECT max(SoldID) AS maxSoldID FROM Accessory_Sells";
                          ...
                          if($MaxSoldIDsINTinteger < 1000)
                          {
                                ...
                                if ((mysqli_num_rows(mysqli_query($link, $InsertedProductNameExistssql)) > 0) && (mysqli_num_rows(mysqli_query($link, $InsertedEmployeeNameExistssql)) > 0))
                                {
                                      if($OldCustomer == True)
                                      {
                                            $sql = "INSERT INTO Accessory_Sells (SoldID, StoreID, EmpID, AccessoryID, CustomerID, Quantity, Price_per_Piece, Commission_in_Percentage, Sold_Date) VALUES ('$NextSoldID', '$InsertedStoreNameValue', '$InsertedEmployeeNameValue', '$InsertedProductNameValue', '$NextCustomerID', '$InsertQuantity', '$InsertPrice', $InsertCommission, '$InsertDate')";
                                            if(mysqli_query($link, $sql))
                                            {
                                                 echo "<h4 align='center' style='font-family: serif;'>" . "Records inserted successfully." . "</h4>";
                                                 echo "<h4 align='center' style='font-family: serif;'>" . $InsertStoreName . " sold " . $InsertQuantity . " number of the Accessory(s) " . $InsertProdtuctName . " to the customer " . $InsertCustomerName . " through the employee " . $InsertEmployeeName . " on " . $InsertDate . "." . "</h4>" . "<br/>";
                                            }
                                            else
                                      ...
                                      else if ($OldCustomer == False)
                                      {
                                            ...
                                            {
                                                 $sql4 = "INSERT INTO Accessory_Sells (SoldID, StoreID, EmpID, AccessoryID, CustomerID, Quantity, Price_per_Piece, Commission_in_Percentage, Sold_Date) VALUES ('$NextSoldID', '$InsertedStoreNameValue', '$InsertedEmployeeNameValue', '$InsertedProductNameValue', '$NextCustomerID', '$InsertQuantity', '$InsertPrice', $InsertCommission, '$InsertDate')";
                                                 if(mysqli_query($link, $sql4))
                                                 {
                                                       echo "<h4 align='center' style='font-family: serif;'>" . "Records inserted successfully." . "</h4>";
                                                       echo "<h4 align='center' style='font-family: serif;'>" . $InsertStoreName . " sold " . $InsertQuantity . " number of the Accessory(s) " . $InsertProdtuctName . " to the customer " . $InsertCustomerName . " through the employee " . $InsertEmployeeName . " on " . $InsertDate . "." . "</h4>";
                                                 }
                                                 else
                                                       echo "<h4 align='center' style='font-family: serif;'>" . "Product selling records insertion failed. " . mysqli_error($link) . "</h4>";
          ...
          <h2 class="sub-header">Sales History
                <form class="navbar-form navbar-right" method="POST" style="position : relative; bottom : 15px;">
                     <input type="text" style="width: 300px;" class="form-control" name="search" placeholder="Custom List Accessory Purchase History">
            ...
            <table class="table table-striped">
              <thead>
                <tr>
                  ...
                  <th><h4 align="center" style="font-weight: bold; font-family: serif;">Accessory</h4></th>
              ...
              <tbody>
                  <?php
                        ...
                        if(isset($_POST['search']))
                        {
                        	...
                        	$sql1 = "SELECT DISTINCT Store_Name, Accessory_Name, Company_Name, Emp_Name, Customer_Name, Quantity, Price_per_Piece, Sold_Date FROM Store AS s, Accessory AS p, Company AS c, Employee AS e, Customer AS c1, Accessory_Sells AS pp WHERE pp.StoreID=s.StoreID AND pp.EmpID=e.EmpID AND pp.CustomerID=c1.CustomerID AND pp.StoreID=s.StoreID AND pp.AccessoryID=p.AccessoryID AND p.CompanyID=c.CompanyID AND (Store_Name LIKE '%$searchq%' OR Customer_Name LIKE '%$searchq%' OR Emp_Name LIKE '%$searchq%' OR Accessory_Name LIKE '%$searchq%' OR Company_Name LIKE '%$searchq%') ORDER BY Sold_Date DESC" ;
                        }
                        else
                              $sql1 = "SELECT DISTINCT Store_Name, Accessory_Name, Company_Name, Emp_Name, Customer_Name, Quantity, Price_per_Piece, Sold_Date FROM Store AS s, Accessory AS p, Company AS c, Employee AS e, Customer AS c1, Accessory_Sells AS pp WHERE pp.StoreID=s.StoreID AND pp.EmpID=e.EmpID AND pp.CustomerID=c1.CustomerID AND pp.StoreID=s.StoreID AND pp.AccessoryID=p.AccessoryID AND p.CompanyID=c.CompanyID ORDER BY Sold_Date DESC";
                        if($result1 = mysqli_query($link1, $sql1))
                        {
                              if(mysqli_num_rows($result1) > 0)
                              {
                                   while($row = mysqli_fetch_array($result1))
                                   {
                                        ...
                                        echo "<td align='center' style='font-family: serif;'>" . $row['Accessory_Name'] . "</td>";
