        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
            <div class="placeholder">
                  <a href="Purchase An Accessory.php#JumpToForms"><img src="Purchase An Accessory.jpg" width="700" height="100%" class="img-responsive" alt="Generic placeholder thumbnail" style="border-radius:30px;"></a>
                  <h4 id="JumpToForms">Our Purchases</h4>
                  <span class="text-muted">Accessories</span>
                  <br/><br/><br/>
                  <h4>Have An Accessory Purchase</h4>
            </div>
          ...
          <Purchase>
              <?php
                    ...
                    if(isset($_POST['StoreName']) && isset($_POST['ProductName']) && isset($_POST['CompanyName']) && isset($_POST['Quantity']) && isset($_POST['PricePerPiece']) && isset($_POST['PurchaseDate']))
                    {
                          ...
                          $MaxPurchaseIDsql = "SELECT max(AccessoryID) AS max FROM Accessory_Purchase";
                          ...
                          if($MaxPurchaseIDsINTinteger < 1000)
                          {
                                ...
                                {
                                      $sql = "INSERT INTO Accessory_Purchase (PurchaseID, StoreID, AccessoryID, CompanyID, Quantity, Price_per_Piece, Purchase_Date) VALUES ('$NextPurchaseID', '$InsertedStoreNameValue', '$InsertedProductNameValue', '$InsertedCompanyNameValue', '$InsertQuantity', '$InsertPrice', '$InsertDate')";
                                      if(mysqli_query($link, $sql)){
                                            echo "<h4 align='center' style='font-family: serif;'>" . "Records inserted successfully." . "</h4>";
                                            echo "<h4 align='center' style='font-family: serif;'>" . $InsertStoreName . " Purchased " . $InsertQuantity . " quantities of the accessory " . $InsertProdtuctName . " from the company " . $InsertCompanyName . " on " . $InsertDate . "." . "</h4>" . "<br/>";
                                      }
                                      else{
              ...
              <tbody>
                  <?php
                        ...
                        if(isset($_POST['search']))
                        {
                        	...
                        	$sql1 = "SELECT DISTINCT Store_Name, Accessory_Name, Company_Name, Quantity, Price_per_Piece, Purchase_Date FROM Store AS s, Accessory AS p, Company AS c, Accessory_Purchase as pp WHERE pp.StoreID=s.StoreID AND pp.StoreID=s.StoreID AND pp.AccessoryID=p.AccessoryID AND pp.CompanyID=c.CompanyID AND (Store_Name LIKE '%$searchq%' OR Accessory_Name LIKE '%$searchq%' OR Company_Name LIKE '%$searchq%') ORDER BY Purchase_Date DESC" ;
                        }
                        else
                              $sql1 = "SELECT DISTINCT Store_Name, Accessory_Name, Company_Name, Quantity, Price_per_Piece, Purchase_Date FROM Store AS s, Accessory AS p, Company AS c, Accessory_Purchase as pp WHERE pp.StoreID=s.StoreID AND pp.StoreID=s.StoreID AND pp.AccessoryID=p.AccessoryID AND pp.CompanyID=c.CompanyID ORDER BY Purchase_Date DESC";
