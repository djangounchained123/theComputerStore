        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
            <div class="placeholder">
                  <a href="Sell A Product.php#JumpToForms"><img src="Sell A Product.jpg" width="700" height="100%" class="img-responsive" alt="Generic placeholder thumbnail" style="border-radius:30px;"></a>
                  <h4 id="JumpToForms">Our Sales</h4>
                  <span class="text-muted">Products & Accessories</span>
                  <br/><br/><br/>
                  <h4>Sell A Product</h4>
            </div>
            <div style="align: center; position : relative; right: 40%">
                 <form class="navbar-form navbar-right" style="position : relative;">
                      <table style="margin: 10px">
                      <div><input type = "button" class="form-control" value="Sell Computers" onclick="window.location.href='Sell A Computer.php'"/>
                      <div><br/><input type = "button" class="form-control" value="Sell Accessories" onclick="window.location.href='Sell An Accessory.php'"/>
                      </table>
                </form>
             </div>
          </div>
                          ...
                          if($MaxPurchaseIDsINTinteger < 1000)
                          {
                                ...
                                if ((mysqli_num_rows(mysqli_query($link, $InsertedProductNameExistssql)) > 0) && (mysqli_num_rows(mysqli_query($link, $InsertedCompanyNameExistssql)) > 0))
                                {
                                      ...
                                      if(mysqli_query($link, $sql)){
                                            ...
                                            echo "<h4 align='center' style='font-family: serif;'>" . $InsertStoreName . " Purchased " . $InsertQuantity . " quantities of the product " . $InsertProdtuctName . " from the company " . $InsertCompanyName . " on " . $InsertDate . "." . "</h4>" . "<br/>";
                                      }
                                      else{
