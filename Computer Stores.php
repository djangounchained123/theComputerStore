      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="Computer Stores.php">Categories<span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Computer Stores
          <form class="navbar-form navbar-right" method="POST" style="position : relative; bottom : 15px;">
            <input type="text" style="width: 300px;" class="form-control" name="search" placeholder="Custom List Stores">
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              <thead>
                <tr>
                  <th><h4 align='center' style='font-weight: bold; font-family: serif;'>Identity</h4></th>
              ...
              <tbody>
                  <?php
                        ...
                        if(isset($_POST['search']))
                        {
                        	...
                        	$sql = "SELECT StoreID, Store_Name, Store_Phone, Store_Email FROM Store WHERE StoreID LIKE '%$searchq%' OR Store_Name LIKE '%$searchq%'" ;
                        }
                        else
                              $sql = "SELECT StoreID, Store_Name, Store_Phone, Store_Email FROM Store";
                        if($result = mysqli_query($link, $sql))
                        {
                              if(mysqli_num_rows($result) > 0)
                              {
                                   ...
                                   {
                                        echo "<tr>";
                                        echo "<td align='center' style='font-weight: bold; font-family: serif;'>" . $row['StoreID'] . "</td>";
                                        ...
                                        echo "<td align='center' style='font-family: serif;'>" . $row['Store_Email'] . "</td>";
                                        echo "</tr>";
                                  }
